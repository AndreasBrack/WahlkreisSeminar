...
#define FAK_1					    10		/**< Faktor vor a_max */
#define KOSTEN_VERSCHWK 			20		/**< Strafkosten falls benachbarte Kreisgleiche Städte verschiedene Wahlkreise erhalten*/
...
SCIP_DECL_READERREAD(ReaderWP::scip_read)
{
	...
	*result = SCIP_DIDNOTRUN;
	...
	varname << "a_max";
	SCIP_CALL( SCIPcreateVar(scip, &var, varname.str().c_str(), 0.0, 0.9, FAK_1, SCIP_VARTYPE_CONTINUOUS,
		  TRUE, FALSE, NULL, NULL, NULL, NULL, NULL) );
