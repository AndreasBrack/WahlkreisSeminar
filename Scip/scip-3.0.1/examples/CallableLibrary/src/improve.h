...
class heur_improve: public scip::ObjHeur {
	GRAPH* graph; /**< the underlying graph of the TSP */
	SCIP_SOL* sol; /**< current solution */

public:
	/** default constructor */
	heur_improve(SCIP* scip) :
			ObjHeur(scip, "improve", "Improve", 'I', 50000, 1000, 0, 0,
					SCIP_HEURTIMING_AFTERNODE, FALSE) {
	}

	/** destructor */
	virtual ~heur_improve() {
	}
